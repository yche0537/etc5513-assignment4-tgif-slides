...
```{r country, echo = FALSE, message = FALSE, warning = FALSE, fig.cap="Top six countries' meat production from 1961 to 2018", fig.width=10, fig.height=6, fig.align='center'}
...
```{r fig1, echo = FALSE , message = FALSE, warning = FALSE, fig.cap = "Global meat production by livestock type, 1961 to 2018", fig.height = 7, fig.width = 10, fig.align='center'}
production <- GD %>%
  select(-Code) %>% 
